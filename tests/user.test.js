...
test('Should signup a new user', async () => {
    ...
    expect(response.body.user.avatar).toBe(undefined)
...
test('Should not login with nonexisting account', async () => {
...
test('Should update valid user fields', async () => {
    ...
    const user = await User.findById(userOneId)
    expect(user.name).toBe("Mike Richter")
